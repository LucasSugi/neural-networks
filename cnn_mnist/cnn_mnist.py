...
def cnn_model_fn(features, labels, mode):
  ...
  pool2_flat = tf.reshape(pool2, [-1, 7 * 7 * filter_layer_2])

  # Dense Layer 1
  dense1 = tf.layers.dense(inputs=pool2_flat, units=units_dense_1, activation=tf.nn.relu)

  # Dense Layer 2
  dense2 = tf.layers.dense(inputs=dense1, units=units_dense_2, activation=tf.nn.relu)
